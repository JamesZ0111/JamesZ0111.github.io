    ...
    <section id="projects" className="pt-40">
      <div className="py-20">
        <h1 className="heading">
          ...
          <span className="text-sandyellow">recent projects</span>
        </h1>
              ...
              <PinContainer title={item.title} href={item.link}>
                ...
                <div className="flex items-center justify-between mt-7 mb-3">
                  ...
                  <div className="flex justify-center items-center">
                    <p className="flex lg:text-xl md:text-xs text-sm text-sandyellow">
                      Check Live Site
                    </p>
                    <FaLocationArrow className="ms-3" color="#CCA16F" />
                  </div>
                </div>
              </PinContainer>
            </a>
